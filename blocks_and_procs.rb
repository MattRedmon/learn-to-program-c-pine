#  code from chap 14 "blocks and procs"
...
class Array
  def each_even(&was_a_block__now_a_proc)
    ...
    self.each do |object|
      ...
      # toggle from even to odd, or odd to each_even
      is_even = !is_even
    end
  end
end
...
# remember we are getting even numbered elements of the arraay, which in this case
# are all od numbers, because i live only to irritate you
